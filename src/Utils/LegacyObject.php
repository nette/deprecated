...
/**
 * Nette\LegacyObject is the ultimate ancestor of all instantiable classes.
 *
...
abstract class LegacyObject
{
	...
	{
		return Nette\Utils\LegacyObjectMixin::call($this, $name, $args);
	}
	...
	public static function extensionMethod($name, $callback = null)
	{
		...
		if ($callback === null) {
			return Nette\Utils\LegacyObjectMixin::getExtensionMethod($class, $name);
		} else {
			Nette\Utils\LegacyObjectMixin::setExtensionMethod($class, $name, $callback);
		}
	}
	...
	{
		return Nette\Utils\LegacyObjectMixin::get($this, $name);
	}
	...
	{
		Nette\Utils\LegacyObjectMixin::set($this, $name, $value);
	}
	...
	{
		return Nette\Utils\LegacyObjectMixin::has($this, $name);
	}
	...
	{
		Nette\Utils\LegacyObjectMixin::remove($this, $name);
	}
}
